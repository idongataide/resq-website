    ...
    <div class="container position-relative">
        <div class="row pt-12 mb-14 xxl-pt-7 xl-pt-6 xxl-mb-7 sm-pt-30 xs-mb-35px">
            <div class="col text-center" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                ...
                <div class="d-flex align-items-center justify-content-center flex-wrap mt-40px xs-mt-30px">
                    <a href="#"   class="btn btn-medium btn-primary btn-rounded d-inline-block me-30px xs-me-10px btn-box-shadow btn-switch-text sm-mt-6px sm-mb-7px section-link">
                        <span>
        ...
        <div class="row align-items- justify-content-center">   
            <div class="position-absolute left-0px right-0px">
                <img src="assets/img/rays.svg" alt="">
            </div>
            <div class="position-relative atropos" data-atropos="">  
    ...
    <div class="container">
        ...
        <div class="col-lg-12 mx-auto text-center text-lg-start" >
            <div class="row" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 2000, "delay": 0, "staggervalue": 400, "easing": "easeOutQuad" }'>
                <div class="col-lg-6 sm-mb-7 mb-2 position-relative">                   
                ...
                <div class="col-lg-6 sm-mb-7 mb-2">
                  <div class="bg-gray-2 d-flex align-items-center justify-content-center p-10 overflow-hidden position-relative">
                        <div class="col-md-6">

                         </div>
                        <div class="col-md-6 ">
                            <h3 class="fw-500 fs-24 text-gray-3 mb-2">Verified, Insured Tow Operators</h3>
                            <p class="text-gray">Experienced professionals. <br/> Fully vetted. Always accountable.</p>
                        </div>
                        <div class="position-absolute right-abs">
                             <img src="assets/img/rays1.svg" alt="">
                        </div>
                    </div>   
                </div>   
                <div class="col-lg-4 sm-mb-7 mb-2">
